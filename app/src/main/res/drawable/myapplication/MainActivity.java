...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.myapplication.ArabicTTS tts;
...
voice.start();
        ...
        tts = new com.example.myapplication.ArabicTTS();
    ...
    private void image() {
        Intent intent = new Intent(this , com.example.myapplication.image.class);
    ...
    public void vedio(View view) {
        Intent intent = new Intent(this , com.example.myapplication.Vedio.class);
        startActivity(intent);
